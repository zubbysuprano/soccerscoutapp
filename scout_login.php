...
?>
    ...
    <div class="container mb-5 mt-3">
        <div class="row w-75 mx-auto">
            <h4 class="text-success">Scout Log In</h4>
  ...
  ?>
            <form action="process/scout_login_process.php" method="post" id="scoutloginForm">
                <div class="mb-3">
                ...
                <div class="modal-footer">
                    <button type="submit" class="joinbutton btn btn-lg btn-success" name="btnscoutlogin">Login</button>
                   
                </div>
                <hr>
                <div class="text-center">
                    <p class="text-success">Do not have a scout account?</p> <a href="scout_signup.php" class="btn btn-success">Sign Up</a>
                </div>
